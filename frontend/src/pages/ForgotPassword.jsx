...
const ForgotPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setIsLoading(true);
        try {
            const res = await axios.post('https://hrms-platform-jkdz.onrender.com/api/auth/forgot-password', { email });
        ...
        >
            ...
            >
                ...
                <div className="mt-8 text-center">
                    <Link to="/login" className="text-sm text-slate-500 dark:text-slate-400 flex items-center justify-center hover:text-primary-600 transition-colors">
